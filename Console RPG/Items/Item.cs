...
namespace Console_RPG
{
    abstract class Item
    {
        public static ChiliDog chiliDog = new ChiliDog("A traditional Chili Dog", "The best of both worlds, Chili, and Hot Dog, what a combo!", 15, 5, 20);
        public static chaoCola chaoCola = new chaoCola("The World-Renown Chao Cola™", "A refreshing drink for a refreshing world!", 8, 5, 10);
